...
sudo apt-get -y install wfuzz gh kitty villain zaproxy seclists putty-tools powercat certipy-ad  coreutils lolcat httptunnel build-essential grc gcc cryptsetup steghide traceroute feroxbuster hping3 zsh remmina keepass2 coreutils moreutils xclip ftp exploitdb locate netdiscover feh rdesktop snmp dirsearch docker-compose docker.io scrub jq apache2 ncat ntpsec-ntpdate rlwrap metasploit-framework ipcalc xsltproc swaks flameshot ghex hexedit
...
wget https://raw.githubusercontent.com/KermitPurple96/scripts/refs/heads/main/Python/shellListener.py -O /home/$SUDO_USER/dev/python/shell
...
wget https://raw.githubusercontent.com/KermitPurple96/i3-kitty/refs/heads/main/fish/fish_variables -O /home/$SUDO_USER/.config/fish/fish_variables
...
sudo ln -s -f /home/$SUDO_USER/.config/fish/fish_variables /root/.config/fish/fish_variables
